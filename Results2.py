...
def result_fn2(root,possibleSolutions,corData,numSieves,numStockPiles,entries,sieve_entries,mainroot, StretchingError):
...
################################################################## GRAPH ##################################################################
    ...
    low_lim2=[]
    for i in range(0,numSieves):
        xx = corData[i][0] - StretchingError.get()
        if (xx >= 0):
            low_lim2.append(xx)
        else:
            low_lim2.append(0)
    up_lim2 = []
    for i in range(0, numSieves):
        yy = corData[i][1] + StretchingError.get()
        if (yy<=100):
            up_lim2.append(yy)
        else:
            up_lim2.append(100)
    ...
    plot1.scatter(x,low_lim,color = 'blue')
    plot1.plot(x,low_lim,color = 'blue', label="Lower\nLimit")
    plot1.scatter(x, up_lim2, color = 'orange')
    plot1.plot(x,up_lim2,linestyle='dotted', color = 'orange', label="New upper\nLimit")
    plot1.scatter(x, up_lim, color = 'orange')
    plot1.plot(x,up_lim, color = 'orange', label="Upper\nLimit")
    plot1.scatter(x, low_lim2,color = 'blue')
    plot1.plot(x,low_lim2,linestyle='dotted',color = 'blue', label="New lower\nLimit")
    ...
    if (numsol > 0):
        ...
        plot1.scatter(x,sol,color = 'green')
        plot1.plot(x,sol,color = 'green',label="Solution")

    plot1.invert_xaxis()
    # creating the Tkinter canvas
    # containing the Matplotlib figure
    plot1.legend(loc='upper center', bbox_to_anchor=(0.5, 1.175),
              fancybox=True, shadow=True, ncol=5, columnspacing=0.5)
